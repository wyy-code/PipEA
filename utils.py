...
#      pos2 = netmf(nx.to_scipy_sparse_matrix(G2, nodelist=list(range(len(G2)))),128)
    ...
    # id1 = sp.identity(adj_p_1.shape[0],dtype="float64")
    # id2 = sp.identity(adj_p_2.shape[0],dtype="float64")
    # rwr_1 = computeP4svd(adj_p_1,id1,threshold=1e-5,alpha=0.5)
    # rwr_2 = computeP4svd(adj_p_2,id2,threshold=1e-5,alpha=0.5)
